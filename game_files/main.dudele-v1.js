...
//Moved array for random letter words - begin. 
    var La = [
		...
		//need to delete off all other words for last day logic
      ],
      Ta = [    /* DICTIONARY WORDS*/
...
/*     function Ga(e) {
    ...
    function isOnLastPuzzle() {
      return Ga(new Date()) >= (La.length - 1);
    }	
//last day logic - End. 		
      ...
      ts = (function (e) {
        ...
        function t() {
          ...
          return (
            ...
            !e.lastPlayedTs || (Na(new Date(e.lastPlayedTs), e.today) >= 1 && Na(Ha, e.today) <= La.length - 1) //for last day
    ...
    function As(e, a, s) {
      try {
        (t = navigator.userAgent || navigator.vendor || window.opera),
          (!/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kdudele|lge |maemo|midp|mmp|mobile.+firefox|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows ce|xda|xiino/i.test(
            t
          ) &&
				...
				//Changed to TRIVIA in Dudele
                 if ((e.gameApp.gameStatus == "WIN" || e.gameApp.gameStatus == "FAIL") && funFacts.length > (e.gameApp.dayOffset - 314)) {
                  ...
                  if (funFact != "") {
                    ...
                    ff.innerHTML = funFact; //changed to HTML for last day
